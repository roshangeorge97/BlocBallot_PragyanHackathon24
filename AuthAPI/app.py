...
try:
    cred = credentials.Certificate("C:/Users/ROSHAN GEORGE/Blockchain_Voting_System/AuthAPI/testy-78a7d-firebase-adminsdk-48m9n-04e78156ff.json")
    initialize_app(cred, {'storageBucket': "testy-78a7d.appspot.com"})
